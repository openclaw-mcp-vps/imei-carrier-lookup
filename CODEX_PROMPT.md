# Build Task: imei-carrier-lookup

Build a complete, production-ready Next.js 15 App Router application.

PROJECT: imei-carrier-lookup
HEADLINE: IMEI Carrier Lookup — paste IMEI, get carrier + unlock policy + scam risk
WHAT: Paste IMEI, get device model, carrier, SIM lock status, unlock policy for that carrier, and fraud risk score. No signup needed for single lookup.
WHY: Existing tools charge $5-15 per lookup, are bloated with ads, or require signup. Clean API + pay-as-you-go wins on UX.
WHO PAYS: Phone resellers, buyers of used phones, people moving carriers
NICHE: phone-tools
